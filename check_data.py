...
clf_name = "CatBoostClassifier"  # "LGBMClassifier", "XGBClassifier", "CatBoostClassifier"
...
X_tr, X_val, y_tr, y_val = train_test_split(
    ...
    stratify=y_train if learning_task == "classification" else None,
)
...
tuned_cv_result = exp.optimize_params(
    X_tr, y_tr, X_val, y_val, max_evals=max_hyperopt_eval, sample_weight=sample_weights, verbose=True
)

print("Run fitting with tuned params...")
model = exp.fit(tuned_cv_result['params'], X_train, y_train,
