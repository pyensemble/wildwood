...
for dataset_name in dataset_names:
    ...
    print("")
    print("Loading datasets {} with categorical features".format(dataset_name))
    print("")
    ...
    for reg in regressors_categorical:
        ...
        print("")
        print("Benchmarking {} regressor on datasets {}".format(reg.__name__, dataset_name))
        print("")
        record = reg(dataset)
    ...
    print("")
    print("Loading datasets {} with one hot categorical features".format(dataset_name))
    print("")
    dataset = datasets.load_dataset(args, as_pandas=True)
    dataset.info()
